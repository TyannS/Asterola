...
public class EmeraldChestplateItem extends Item {
    public EmeraldChestplateItem(Properties properties) {
        super(properties.humanoidArmor(ModArmorMaterials.EMERALD, ArmorType.CHESTPLATE));
    }
