...
public class EmeraldLeggingsItem extends Item {
    public EmeraldLeggingsItem(Properties properties) {
        super(properties.humanoidArmor(ModArmorMaterials.EMERALD, ArmorType.LEGGINGS));
    }
